        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">PESeaT<img class="img-rounded" src="images/icn.png" alt=""> </a>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>PES, Bangalore</p>
                                    <h5>Phone: +919353325788</a></h5> </div>
                ...
                <div class="modal-body cart-addon">
                    <div class="food-item white">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs. 200</span></div>
